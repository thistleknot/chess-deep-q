...
from chessdq.evaluation import (fast_evaluate_position, find_threatened_squares,
                        find_guarded_squares, evaluate_by_player)
from chessdq.board_utils import get_legal_moves_from_square, get_secondary_moves, get_move_uci
from chessdq.difficulty import DifficultyController
...
class TerminalChessBoard:
    ...
    def prompt_load_game(self):
        ...
        from chessdq.game_play import list_saved_games, load_game_from_pgn
    ...
    def load_game(self, filename="game.pgn"):
        ...
        from chessdq.game_play import load_game_from_pgn
    ...
    def save_game(self, filename=None):
        ...
        from chessdq.game_play import save_game_to_pgn
