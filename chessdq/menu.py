...
def play_mode():
    ...
    from chessdq.agents import make_agent, AgentAdapter
    name = _pick_agent()
...
def train_mode():
    ...
    from chessdq.train_control import train
...
def measure_mode():
    ...
    from chessdq.agents import make_agent
...
def _load_calibrator():
    ...
    import os
    from chessdq.elo_calibration import TemperatureEloCalibrator
    from chessdq.constants import ELO_CALIBRATION_PATH
